...
public class TV extends InteractiveTileObject {
    ...
    public TV(World world, TiledMap map, Rectangle rectangle, Pandoradca game, PlayScreen screen) {
    ...
    public void onHit() {
        ...
        if (screen.getHud().getQuestion() < 5) {
            screen.getResults().getHouseAnswers()[screen.getHud().getQuestion()] = "Oglądanie telewizji";
